    ...
    <main class="mx-5 my-4">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                $statement = $conn->prepare("SELECT * FROM `session`");
                $statement->execute();
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="POST">
                                <a href="sessionsCRUD.php?courID=<?php echo $session['ID_session']; ?>" class="btn btn-primary">Sessions</a>
                ...
                <?php
                    ...
                    // if (isset($_POST['delete'])) {
                        ...
                        // (en cours d'inscription, inscription achevée, annulée, en cours, cloturée)
