        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light mx-2">
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a class="dropdown-item" href="#">Sessions list & Learners registered</a></li>
                    <li><a class="dropdown-item" href="#">Rate learners</a></li>
                    <li><a class="dropdown-item" href="#">Edit a course</a></li>
                    <li>
